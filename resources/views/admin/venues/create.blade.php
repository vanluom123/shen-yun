@extends('layouts.app', ['title' => 'Admin – Thêm địa điểm'])

@section('content')
    <div class="mx-auto max-w-2xl">
        <div class="flex items-center justify-between gap-4">
            <div>
                <h1 class="text-2xl font-semibold tracking-tight">Thêm địa điểm</h1>
                <p class="mt-1 text-sm text-neutral-600">Tạo địa điểm mới.</p>
            </div>
        ...
        <div class="mt-6 rounded-xl border border-neutral-200 bg-white p-6 shadow-sm">
            <form method="post" action="{{ url('/admin/venues') }}">
                @csrf
